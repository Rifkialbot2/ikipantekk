...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/ikibot/monot"
        ),
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @kingwibu \
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            text="๏ I'm *zimytrixs*, a powerful group management bot built to help you manage your group easily."
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Skyzu", url="t.me/kingswibu"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
                    ],
